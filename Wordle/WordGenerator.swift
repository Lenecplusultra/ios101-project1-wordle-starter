...
class WordGenerator {
  ...
  // Checkpoint: After finishing this exercise, you should now have a different goal word each time you run the app! Try printing out the selected goal word to check. If it's not working, check that you have done this exercise correctly.
    static let possibleWords = [
      "AUDIO", "CRANE", "BLINK", "MOUNT", "TREND",
      "WORLD", "SUGAR", "PLANT", "SHINE", "GLORY",
      "BRAIN", "CLEAN", "DRIVE", "EAGER", "FAITH",
      "GRACE", "HAPPY", "INDEX", "JUMBO", "KNACK",
      "LIGHT", "MIGHT", "NOBLE", "OCEAN", "PRIDE",
      "QUICK", "RIDER", "SMART", "TASTE", "UNION",
      "VIVID", "WORTH", "YOUTH", "ZEBRA", "TRUST",
      "SPEAR", "CROWN", "FRESH", "CHILD", "GHOST"
    ]
